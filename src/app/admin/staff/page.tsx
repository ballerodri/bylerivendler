...
export default async function AdminStaffPage() {
  ...
  const { data } = await admin
    .from("staff")
    .select("id, user_id, full_name, role, email, active, created_at")
        ...
        <div className="adm-card">
          {staff.map((s) => (
            <div key={s.id} className="adm-list-row adm-list-row--staff">
              ...
              <div>
                <span
                  className={`adm-pill ${s.role === "admin" ? "adm-pill--admin" : "adm-pill--inactive"}`}
                >
              ...
              <div>
                <span
                  className={`adm-pill ${s.active ? "adm-pill--active" : "adm-pill--inactive"}`}
                >
